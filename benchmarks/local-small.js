...
var imNativeArgs = ['strip', 'interlace', 'Plane', 'filter', 'Lagrange', 'resize', '100x100^', 'extent', '100x100', 'format', 'webp'];
var imSpawnArgs = ['-strip', '-interlace', 'Plane', '-filter', 'Lagrange', '-resize', '100x100^', '-background', 'transparent', '-extent', '100x100', 'webp:-'];
