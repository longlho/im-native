...
var imNativeArgs = ['filter', 'Lagrange', 'resize', '100x100', 'gravity', 'NorthGravity', 'extent', '100x100', 'format', 'webp'];
var imSpawnArgs = ['-filter', 'Lagrange', '-resize', '100x100', '-background', 'transparent', '-gravity', 'North', '-extent', '100x100', 'webp:-'];
